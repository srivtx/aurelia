...
export const HeroIllustration = (props: P) => (
  <svg viewBox="0 0 240 220" fill="none" {...props}>
    ...
    <path d="M112 78c4 2 9 2 13 0" stroke="var(--ink-2)" strokeWidth="1.6" strokeLinecap="round" opacity="0.5" />
    {/* neck + shoulders */}
    <path
    ...
    />
    {/* arm holding palette */}
    <path d="M156 148c8 4 13 10 14 18" stroke="var(--ink-2)" strokeWidth="2" strokeLinecap="round" />
    <path d="M158 142c10 2 17 9 18 20l2 14" stroke="var(--ink-2)" strokeWidth="2" strokeLinecap="round" />
    {/* palette */}
    <path
      ...
      strokeWidth="2"
    />
    <circle cx="177" cy="172" r="2.2" fill="var(--primary)" />
    <circle cx="185" cy="171" r="2.2" fill="var(--secondary)" />
    <circle cx="181" cy="180" r="2.2" fill="var(--cat-skin)" />
    {/* hair strand front */}
    <path d="M96 64c6-8 16-12 26-10" stroke="var(--ink-2)" strokeWidth="1.6" strokeLinecap="round" opacity="0.6" />
    {/* sparkles */}
    <path d="M64 92c1 4 2.6 5.6 6.6 6.6-4 1-5.6 2.6-6.6 6.6-1-4-2.6-5.6-6.6-6.6 4-1 5.6-2.6 6.6-6.6Z" fill="var(--accent)" opacity="0.85" />
    <path d="M196 116c.8 3.2 2 4.4 5.2 5.2-3.2.8-4.4 2-5.2 5.2-.8-3.2-2-4.4-5.2-5.2 3.2-.8 4.4-2 5.2-5.2Z" fill="var(--primary)" opacity="0.7" />
  </svg>
);
...
export const QuizIllustration = (props: P) => (
  <svg viewBox="0 0 200 160" fill="none" {...props}>
    ...
    <path
      ...
      strokeLinecap="round"
    />
    <path d="M78 36c5 3 11 3 16 0" stroke="var(--ink-2)" strokeWidth="1.5" strokeLinecap="round" opacity="0.5" />
    {/* bun */}
    <circle cx="58" cy="36" r="10" fill="var(--sage-soft)" stroke="var(--ink-2)" strokeWidth="2" />
    <path d="M62 28c6-6 16-6 21 1" stroke="var(--ink-2)" strokeWidth="2" strokeLinecap="round" />
    {/* neck + shoulder */}
    <path d="M92 70c0 6 2 10 6 13M76 68c0 6-2 10-6 13" stroke="var(--ink-2)" strokeWidth="2" strokeLinecap="round" />
    <path d="M56 108c5-11 15-17 27-17s22 6 27 15v18H50v-16Z" fill="var(--sage-soft)" stroke="var(--ink-2)" strokeWidth="2" strokeLinejoin="round" />
    {/* thought bubbles with category marks */}
    <path d="M112 52h56M130 52v0" stroke="none" />
    <circle cx="140" cy="42" r="17" fill="var(--surface)" stroke="var(--ink-2)" strokeWidth="1.8" />
    <circle cx="128" cy="62" r="4" fill="var(--surface)" stroke="var(--ink-2)" strokeWidth="1.5" />
    <circle cx="120" cy="72" r="2.4" fill="var(--surface)" stroke="var(--ink-2)" strokeWidth="1.2" />
    {/* droplet inside bubble */}
    <path d="M140 32s6.5 6.6 6.5 11a6.5 6.5 0 1 1-13 0c0-4.4 6.5-11 6.5-11Z" stroke="var(--cat-skin)" strokeWidth="1.8" strokeLinejoin="round" />
    <path d="M168 86c.9 3.4 2.2 4.7 5.6 5.6-3.4.9-4.7 2.2-5.6 5.6-.9-3.4-2.2-4.7-5.6-5.6 3.4-.9 4.7-2.2 5.6-5.6Z" fill="var(--cat-skin)" />
    <path d="M158 34c.8 3 2 4.2 5 5-3 .8-4.2 2-5 5-.8-3-2-4.2-5-5 3-.8 4.2-2 5-5Z" fill="var(--primary)" opacity="0.75" />
  </svg>
);
...
export const EmptySavedIllustration = (props: P) => (
  <svg viewBox="0 0 160 160" fill="none" {...props}>
    <path
      ...
      opacity="0.5"
    />
    <circle cx="72" cy="62" r="34" fill="var(--surface)" stroke="var(--ink-2)" strokeWidth="2" />
    <path d="M52 44c4-6 10-10 16-11" stroke="var(--rose-soft)" strokeWidth="4" strokeLinecap="round" opacity="0.9" />
    <path d="M88 89l10 10" stroke="var(--ink-2)" strokeWidth="2" strokeLinecap="round" />
    <path
      ...
      strokeLinejoin="round"
    />
    <path d="M34 30c1.2 5 3.2 7 8.2 8.2-5 1.2-7 3.2-8.2 8.2-1.2-5-3.2-7-8.2-8.2 5-1.2 7-3.2 8.2-8.2Z" fill="var(--accent)" opacity="0.9" />
    <path d="M118 118c1 4 2.6 5.6 6.6 6.6-4 1-5.6 2.6-6.6 6.6-1-4-2.6-5.6-6.6-6.6 4-1 5.6-2.6 6.6-6.6Z" fill="var(--primary)" opacity="0.7" />
  </svg>
);
...
export const OnboardingIllustration = (props: P) => (
  <svg viewBox="0 0 220 180" fill="none" {...props}>
    ...
    <path
      ...
      strokeLinecap="round"
    />
    <path d="M82 62c4 2 10 2 14 0" stroke="var(--ink-2)" strokeWidth="1.5" strokeLinecap="round" opacity="0.5" />
    <path d="M86 92c0 6 2 11 5 14M104 90c0 6-2 11-5 14" stroke="var(--ink-2)" strokeWidth="2" strokeLinecap="round" />
    <path d="M56 128c5-11 15-18 27-18 6 0 11 1 16 4" stroke="var(--ink-2)" strokeWidth="2" strokeLinecap="round" />
    <path d="M60 121c6-12 15-18 26-18s21 6 26 14v23H58v-16Z" fill="var(--terra-soft)" stroke="var(--ink-2)" strokeWidth="2" strokeLinejoin="round" />
    {/* hair */}
    <path
    ...
    <path d="M108 112c10 0 18 4 22 10" stroke="var(--ink-2)" strokeWidth="2" strokeLinecap="round" />
    <circle cx="142" cy="128" r="17" fill="var(--surface)" stroke="var(--ink-2)" strokeWidth="2" />
    <circle cx="142" cy="128" r="11" fill="var(--sage-soft)" opacity="0.8" />
    <path d="M132 120c3-4 7-7 11-7" stroke="#FFF" strokeWidth="3" strokeLinecap="round" opacity="0.9" />
    <path d="M142 145v8" stroke="var(--ink-2)" strokeWidth="2.4" strokeLinecap="round" />
    {/* sparkles */}
    <path d="M36 44c1 4 2.6 5.6 6.6 6.6-4 1-5.6 2.6-6.6 6.6-1-4-2.6-5.6-6.6-6.6 4-1 5.6-2.6 6.6-6.6Z" fill="var(--accent)" opacity="0.9" />
    <path d="M188 96c.9 3.6 2.3 5 6 5.9-3.7.9-5.1 2.3-6 5.9-.9-3.6-2.3-5-6-5.9 3.7-.9 5.1-2.3 6-5.9Z" fill="var(--primary)" opacity="0.7" />
    <path d="M176 40c.7 2.8 1.8 3.9 4.6 4.6-2.8.7-3.9 1.8-4.6 4.6-.7-2.8-1.8-3.9-4.6-4.6 2.8-.7 3.9-1.8 4.6-4.6Z" fill="var(--cat-skin)" opacity="0.8" />
  </svg>
);
...
export const SearchIllustration = (props: P) => (
  <svg viewBox="0 0 160 140" fill="none" {...props}>
    ...
    />
    {/* swatch circles */}
    <circle cx="46" cy="88" r="12" fill="var(--primary)" opacity="0.25" />
    <circle cx="70" cy="96" r="10" fill="var(--secondary)" opacity="0.3" />
    <circle cx="92" cy="90" r="11" fill="var(--cat-skin)" opacity="0.3" />
    <circle cx="60" cy="64" r="9" fill="var(--accent)" opacity="0.3" />
    {/* magnifier */}
    <circle cx="84" cy="56" r="24" fill="var(--surface)" stroke="var(--ink-2)" strokeWidth="2.4" />
    <path d="M70 42c5-6 12-9 18-8" stroke="var(--rose-soft)" strokeWidth="4" strokeLinecap="round" opacity="0.9" />
    <path d="m101 73 14 14" stroke="var(--ink-2)" strokeWidth="3.2" strokeLinecap="round" />
    {/* question dots inside lens */}
    <circle cx="80" cy="54" r="2.4" fill="var(--ink-2)" opacity="0.6" />
    <circle cx="90" cy="54" r="2.4" fill="var(--ink-2)" opacity="0.6" />
    <path d="M80 62c4 2 8 2 11 0" stroke="var(--ink-2)" strokeWidth="1.6" strokeLinecap="round" opacity="0.5" />
    <path d="M28 34c.9 3.6 2.3 5 6 5.9-3.7.9-5.1 2.3-6 5.9-.9-3.6-2.3-5-6-5.9 3.7-.9 5.1-2.3 6-5.9Z" fill="var(--primary)" opacity="0.75" />
  </svg>
);
...
export const NotFoundIllustration = (props: P) => (
  <svg viewBox="0 0 180 160" fill="none" {...props}>
    ...
    />
    {/* compact case */}
    <circle cx="84" cy="70" r="36" fill="var(--terra-soft)" stroke="var(--ink-2)" strokeWidth="2.2" />
    <circle cx="84" cy="70" r="26" fill="var(--surface)" stroke="var(--ink-2)" strokeWidth="2" />
    <path d="M66 56c4-6 9-10 15-11" stroke="var(--rose-soft)" strokeWidth="4" strokeLinecap="round" opacity="0.9" />
    {/* heart in the mirror */}
    <path
      ...
      opacity="0.85"
    />
    <path d="M110 98l10 10" stroke="var(--ink-2)" strokeWidth="2.2" strokeLinecap="round" />
    {/* dashed wandering path */}
    <path d="M28 128c12-8 20 6 32-2s18 8 30 0" stroke="var(--ink-2)" strokeWidth="1.8" strokeLinecap="round" strokeDasharray="2 8" opacity="0.55" />
    <path d="M132 30c1 4 2.6 5.6 6.6 6.6-4 1-5.6 2.6-6.6 6.6-1-4-2.6-5.6-6.6-6.6 4-1 5.6-2.6 6.6-6.6Z" fill="var(--accent)" opacity="0.9" />
    <path d="M40 32c.8 3 2 4.2 5 5-3 .8-4.2 2-5 5-.8-3-2-4.2-5-5 3-.8 4.2-2 5-5Z" fill="var(--primary)" opacity="0.7" />
  </svg>
);
...
export const StylistIllustration = (props: P) => (
  <svg viewBox="0 0 200 170" fill="none" {...props}>
    ...
    />
    {/* face */}
    <circle cx="88" cy="76" r="22" fill="var(--surface)" stroke="var(--ink-2)" strokeWidth="2.2" />
    <path d="M66 70c1-12 10-21 22-21 10 0 18 6 21 15" stroke="var(--ink-2)" strokeWidth="2.2" fill="none" />
    {/* eyes + smile */}
    <circle cx="81" cy="76" r="2" fill="var(--ink-2)" />
    <circle cx="95" cy="76" r="2" fill="var(--ink-2)" />
    <path d="M82 85c3 2.6 7 2.6 10 0" stroke="var(--ink-2)" strokeWidth="1.8" strokeLinecap="round" />
    {/* blush */}
    <circle cx="74" cy="82" r="3.4" fill="var(--rose-soft)" />
    <circle cx="100" cy="82" r="3.4" fill="var(--rose-soft)" />
    {/* phone in hand */}
    <rect x="112" y="86" width="30" height="44" rx="7" fill="var(--surface)" stroke="var(--ink-2)" strokeWidth="2.2" />
    <rect x="117" y="93" width="20" height="26" rx="4" fill="var(--terra-soft)" />
    <path d="M121 99h12M121 105h12M121 111h8" stroke="var(--ink-2)" strokeWidth="1.4" strokeLinecap="round" opacity="0.55" />
    {/* hand */}
    <path d="M112 108c-6 1-10 5-10 11 0 5 4 9 10 9" stroke="var(--ink-2)" strokeWidth="2.2" fill="var(--surface)" strokeLinejoin="round" />
    {/* shoulders */}
    <path d="M58 152c4-16 16-24 30-24 12 0 22 6 27 18" stroke="var(--ink-2)" strokeWidth="2.2" fill="none" opacity="0.8" />
    ...
    <path
      ...
      strokeWidth="2.2"
    />
    <path d="M155 46c.9 3.6 2.3 5 6 5.9-3.7.9-5.1 2.3-6 5.9-.9-3.6-2.3-5-6-5.9 3.7-.9 5.1-2.3 6-5.9Z" fill="var(--primary)" />
    <circle cx="143" cy="52" r="1.8" fill="var(--ink-2)" opacity="0.5" />
    <circle cx="167" cy="52" r="1.8" fill="var(--ink-2)" opacity="0.5" />
    {/* floating sparkles */}
    <path d="M46 44c.8 3.2 2 4.4 5 5.2-3 .8-4.2 2-5 5.2-.8-3.2-2-4.4-5-5.2 3-.8 4.2-2 5-5.2Z" fill="var(--accent)" opacity="0.85" />
    <path d="M170 100c.6 2.4 1.5 3.3 3.7 3.9-2.2.6-3.1 1.5-3.7 3.9-.6-2.4-1.5-3.3-3.7-3.9 2.2-.6 3.1-1.5 3.7-3.9Z" fill="var(--primary)" opacity="0.7" />
  </svg>
);
